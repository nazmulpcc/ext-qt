...
PHP_MINIT_FUNCTION(qt)
{
	...
	ce_qscrollbar = register_class_Qt_Widgets_QScrollBar(ce_qabstractslider);
	...
	auto ce_qabstractscrollarea = register_class_Qt_Widgets_QAbstractScrollArea(ce_qframe);
