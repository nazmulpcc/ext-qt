...
AS_VAR_IF([PHP_QT], [no],, [
  ...
  PHP_NEW_EXTENSION([qt],
    [src/Core/QObject.cpp src/Core/QThread.cpp src/Widgets/QApplication.cpp src/Widgets/QBoxLayout.cpp src/Widgets/QWidget.cpp src/Widgets/QLabel.cpp src/Widgets/QLineEdit.cpp src/Widgets/QLayout.cpp src/Widgets/QMainWindow.cpp src/Widgets/QPushButton.cpp qt.cpp],
    [$ext_shared],,
