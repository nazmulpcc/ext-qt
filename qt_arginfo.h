 ...
 * Stub hash: 3867f757d00410482f7bf13c42c83f7470102c93 */
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Qt_Core_QAbstractItemModel_checkIndex, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_OBJ_INFO(0, index, Qt\\Core\\QModelIndex, 0)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, options, IS_LONG, 0, "Qt\\Core\\QAbstractItemModel::NoOption")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Qt_Core_QAbstractItemModel_setHeaderData, 0, 3, _IS_BOOL, 0)
	...
	ZEND_ARG_TYPE_INFO(0, orientation, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, value, IS_MIXED, 0)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, role, IS_LONG, 0, "2")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Qt_Core_QAbstractItemModel_dataChanged, 0, 2, IS_VOID, 0)
	ZEND_ARG_OBJ_INFO(0, topLeft, Qt\\Core\\QModelIndex, 0)
	ZEND_ARG_OBJ_INFO(0, bottomRight, Qt\\Core\\QModelIndex, 0)
ZEND_END_ARG_INFO()
...
#define arginfo_class_Qt_Core_QAbstractListModel___construct arginfo_class_Qt_Core_QAbstractItemModel___construct

#define arginfo_class_Qt_Core_QThread___construct arginfo_class_Qt_Core_QAbstractItemModel___construct

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_Qt_Core_QThread_create, 0, 1, Qt\\Core\\QThread, 0)
	ZEND_ARG_TYPE_INFO(0, function, IS_CALLABLE, 0)
	ZEND_ARG_VARIADIC_TYPE_INFO(0, args, IS_MIXED, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_Qt_Core_QThread_currentThread, 0, 0, Qt\\Core\\QThread, 0)
ZEND_END_ARG_INFO()
...
#define arginfo_class_Qt_Core_QThread_yieldCurrentThread arginfo_class_Qt_Core_QAbstractItemModel_revert

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Qt_Core_QThread_isCurrentThread, 0, 0, _IS_BOOL, 0)
ZEND_END_ARG_INFO()

#define arginfo_class_Qt_Core_QThread_isFinished arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Core_QThread_isInterruptionRequested arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Core_QThread_isRunning arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Core_QThread_requestInterruption arginfo_class_Qt_Core_QAbstractItemModel_revert

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Qt_Core_QThread_setPriority, 0, 1, IS_VOID, 0)
	ZEND_ARG_TYPE_INFO(0, priority, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Qt_Core_QThread_setStackSize, 0, 1, _IS_BOOL, 0)
...
#define arginfo_class_Qt_Core_QThread_quit arginfo_class_Qt_Core_QAbstractItemModel_revert

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Qt_Core_QThread_start, 0, 0, IS_VOID, 0)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, priority, IS_LONG, 0, "Qt\\Core\\QThread::IdlePriority")
ZEND_END_ARG_INFO()

#define arginfo_class_Qt_Core_QThread_terminate arginfo_class_Qt_Core_QAbstractItemModel_revert

#define arginfo_class_Qt_Core_QThread_onFinished arginfo_class_Qt_Core_QAbstractItemModel_onColumnsAboutToBeInserted

#define arginfo_class_Qt_Core_QThread_onStarted arginfo_class_Qt_Core_QAbstractItemModel_onColumnsAboutToBeInserted

#define arginfo_class_Qt_Core_QThread_run arginfo_class_Qt_Core_QAbstractItemModel_revert

ZEND_BEGIN_ARG_INFO_EX(arginfo_class_Qt_Core_QCalendar___construct, 0, 0, 1)
	ZEND_ARG_TYPE_INFO(0, system, IS_LONG, 0)
ZEND_END_ARG_INFO()

#define arginfo_class_Qt_Core_QCalendar_isValid arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Core_QDate_isNull arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Core_QDate_isValid arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Core_QModelIndex_column arginfo_class_Qt_Core_QThread_idealThreadCount

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Qt_Core_QModelIndex_data, 0, 0, IS_MIXED, 0)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, role, IS_LONG, 0, "0")
ZEND_END_ARG_INFO()

#define arginfo_class_Qt_Core_QModelIndex_isValid arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Core_QModelIndex_row arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Core_QModelIndex_sibling arginfo_class_Qt_Core_QAbstractItemModel_createIndex
...
#define arginfo_class_Qt_Core_QObject_isQuickItemType arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Core_QObject_isWidgetType arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Core_QObject_isWindowType arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Core_QObject_signalsBlocked arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Core_QSize_height arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Core_QSize_isEmpty arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Core_QSize_isNull arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Core_QSize_isValid arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Core_QSize_width arginfo_class_Qt_Core_QThread_idealThreadCount
...
#define arginfo_class_Qt_Core_QTime_hour arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Core_QTime_isNull arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Core_QTime_isValid arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Core_QTime_minute arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Core_QTime_msec arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Core_QTime_second arginfo_class_Qt_Core_QThread_idealThreadCount

ZEND_BEGIN_ARG_INFO_EX(arginfo_class_Qt_Core_QTimeZone___construct, 0, 0, 1)
	ZEND_ARG_TYPE_INFO(0, offsetSeconds, IS_LONG, 0)
ZEND_END_ARG_INFO()

#define arginfo_class_Qt_Core_QTimeZone_isValid arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Widgets_QAbstractButton_autoRepeat arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QAbstractButton_autoRepeatDelay arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QAbstractButton_autoRepeatInterval arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QAbstractButton_isChecked arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Widgets_QAbstractScrollArea_horizontalScrollBarPolicy arginfo_class_Qt_Core_QThread_idealThreadCount
...
#define arginfo_class_Qt_Widgets_QAbstractScrollArea_sizeAdjustPolicy arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QAbstractScrollArea_verticalScrollBarPolicy arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QAbstractSlider_hasTracking arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QAbstractSlider_invertedAppearance arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QAbstractSlider_invertedControls arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QAbstractSlider_isSliderDown arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QAbstractSlider_maximum arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QAbstractSlider_minimum arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QAbstractSlider_orientation arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QAbstractSlider_pageStep arginfo_class_Qt_Core_QThread_idealThreadCount
...
#define arginfo_class_Qt_Widgets_QAbstractSlider_singleStep arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QAbstractSlider_sliderPosition arginfo_class_Qt_Core_QThread_idealThreadCount
...
#define arginfo_class_Qt_Widgets_QAbstractSlider_value arginfo_class_Qt_Core_QThread_idealThreadCount
...
#define arginfo_class_Qt_Widgets_QAbstractSpinBox_alignment arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QAbstractSpinBox_buttonSymbols arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QAbstractSpinBox_correctionMode arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QAbstractSpinBox_hasAcceptableInput arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QAbstractSpinBox_hasFrame arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QAbstractSpinBox_interpretText arginfo_class_Qt_Core_QAbstractItemModel_revert

#define arginfo_class_Qt_Widgets_QAbstractSpinBox_isAccelerated arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QAbstractSpinBox_isGroupSeparatorShown arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QAbstractSpinBox_isReadOnly arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QAbstractSpinBox_keyboardTracking arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Widgets_QAbstractSpinBox_wrapping arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Widgets_QCheckBox_checkState arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QCheckBox_isTristate arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Widgets_QComboBox_count arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QComboBox_currentIndex arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QComboBox_currentText arginfo_class_Qt_Core_QObject_objectName

#define arginfo_class_Qt_Widgets_QComboBox_duplicatesEnabled arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QComboBox_hasFrame arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Widgets_QComboBox_insertPolicy arginfo_class_Qt_Core_QThread_idealThreadCount

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Qt_Widgets_QComboBox_insertSeparator, 0, 1, IS_VOID, 0)
	ZEND_ARG_TYPE_INFO(0, index, IS_LONG, 0)
ZEND_END_ARG_INFO()

#define arginfo_class_Qt_Widgets_QComboBox_isEditable arginfo_class_Qt_Core_QThread_isCurrentThread

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Qt_Widgets_QComboBox_itemText, 0, 1, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, index, IS_LONG, 0)
ZEND_END_ARG_INFO()

#define arginfo_class_Qt_Widgets_QComboBox_maxCount arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QComboBox_maxVisibleItems arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QComboBox_minimumContentsLength arginfo_class_Qt_Core_QThread_idealThreadCount
...
#define arginfo_class_Qt_Widgets_QComboBox_sizeAdjustPolicy arginfo_class_Qt_Core_QThread_idealThreadCount
...
#define arginfo_class_Qt_Widgets_QDateTimeEdit_calendarPopup arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Widgets_QDateTimeEdit_currentSection arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QDateTimeEdit_currentSectionIndex arginfo_class_Qt_Core_QThread_idealThreadCount
...
#define arginfo_class_Qt_Widgets_QDateTimeEdit_sectionCount arginfo_class_Qt_Core_QThread_idealThreadCount
...
#define arginfo_class_Qt_Widgets_QDial_notchSize arginfo_class_Qt_Core_QThread_idealThreadCount

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Qt_Widgets_QDial_notchTarget, 0, 0, IS_DOUBLE, 0)
ZEND_END_ARG_INFO()

#define arginfo_class_Qt_Widgets_QDial_notchesVisible arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Widgets_QDial_wrapping arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Widgets_QFrame_frameShadow arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QFrame_frameShape arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QFrame_frameStyle arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QFrame_frameWidth arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QFrame_lineWidth arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QFrame_midLineWidth arginfo_class_Qt_Core_QThread_idealThreadCount
...
#define arginfo_class_Qt_Widgets_QGroupBox_alignment arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QGroupBox_isCheckable arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QGroupBox_isChecked arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QGroupBox_isFlat arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Widgets_QSlider_tickInterval arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QSlider_tickPosition arginfo_class_Qt_Core_QThread_idealThreadCount
...
#define arginfo_class_Qt_Widgets_QWidget_acceptDrops arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Widgets_QWidget_autoFillBackground arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QWidget_backgroundRole arginfo_class_Qt_Core_QThread_idealThreadCount
...
#define arginfo_class_Qt_Widgets_QWidget_contextMenuPolicy arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QWidget_ensurePolished arginfo_class_Qt_Core_QAbstractItemModel_revert

#define arginfo_class_Qt_Widgets_QWidget_focusPolicy arginfo_class_Qt_Core_QThread_idealThreadCount
...
#define arginfo_class_Qt_Widgets_QWidget_hasFocus arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QWidget_hasMouseTracking arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QWidget_hasTabletTracking arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QWidget_height arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QWidget_inputMethodHints arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QWidget_isActiveWindow arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Widgets_QWidget_isEnabled arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Widgets_QWidget_isFullScreen arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QWidget_isHidden arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QWidget_isMaximized arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QWidget_isMinimized arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QWidget_isModal arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QWidget_isVisible arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QWidget_isVisibleTo arginfo_class_Qt_Widgets_QWidget_isEnabledTo

#define arginfo_class_Qt_Widgets_QWidget_isWindow arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QWidget_isWindowModified arginfo_class_Qt_Core_QThread_isCurrentThread

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_Qt_Widgets_QWidget_layout, 0, 0, Qt\\Widgets\\QLayout, 1)
ZEND_END_ARG_INFO()

#define arginfo_class_Qt_Widgets_QWidget_layoutDirection arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QWidget_maximumHeight arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QWidget_maximumSize arginfo_class_Qt_Widgets_QWidget_baseSize

#define arginfo_class_Qt_Widgets_QWidget_maximumWidth arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QWidget_minimumHeight arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QWidget_minimumSize arginfo_class_Qt_Widgets_QWidget_baseSize

#define arginfo_class_Qt_Widgets_QWidget_minimumWidth arginfo_class_Qt_Core_QThread_idealThreadCount
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Qt_Widgets_QWidget_setAttribute, 0, 1, IS_VOID, 0)
...
#define arginfo_class_Qt_Widgets_QWidget_toolTipDuration arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QWidget_underMouse arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Widgets_QWidget_updatesEnabled arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Widgets_QWidget_width arginfo_class_Qt_Core_QThread_idealThreadCount
...
#define arginfo_class_Qt_Widgets_QWidget_windowFlags arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QWidget_windowModality arginfo_class_Qt_Core_QThread_idealThreadCount
...
#define arginfo_class_Qt_Widgets_QWidget_windowState arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QWidget_windowTitle arginfo_class_Qt_Core_QObject_objectName

#define arginfo_class_Qt_Widgets_QWidget_windowType arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QWidget_x arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QWidget_y arginfo_class_Qt_Core_QThread_idealThreadCount
...
#define arginfo_class_Qt_Widgets_QWidget_focusNextChild arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Widgets_QLabel_wordWrap arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Widgets_QLineEdit_hasSelectedText arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Widgets_QLineEdit_isClearButtonEnabled arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QLineEdit_isModified arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QLineEdit_isReadOnly arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Widgets_QScrollArea_alignment arginfo_class_Qt_Core_QThread_idealThreadCount
...
#define arginfo_class_Qt_Widgets_QSpinBox_displayIntegerBase arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QSpinBox_maximum arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QSpinBox_minimum arginfo_class_Qt_Core_QThread_idealThreadCount
...
#define arginfo_class_Qt_Widgets_QSpinBox_singleStep arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QSpinBox_stepType arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QSpinBox_suffix arginfo_class_Qt_Core_QObject_objectName

#define arginfo_class_Qt_Widgets_QSpinBox_value arginfo_class_Qt_Core_QThread_idealThreadCount
...
#define arginfo_class_Qt_Widgets_QSplitter_childrenCollapsible arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QSplitter_count arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QSplitter_handleWidth arginfo_class_Qt_Core_QThread_idealThreadCount
...
#define arginfo_class_Qt_Widgets_QSplitter_opaqueResize arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Widgets_QStackedWidget_count arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QStackedWidget_currentIndex arginfo_class_Qt_Core_QThread_idealThreadCount
...
#define arginfo_class_Qt_Widgets_QTreeView___construct arginfo_class_Qt_Widgets_QComboBox___construct

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Qt_Widgets_QTreeView_collapse, 0, 1, IS_VOID, 0)
	ZEND_ARG_OBJ_INFO(0, index, Qt\\Widgets\\QModelIndex, 0)
ZEND_END_ARG_INFO()

#define arginfo_class_Qt_Widgets_QTreeView_collapseAll arginfo_class_Qt_Core_QAbstractItemModel_revert

#define arginfo_class_Qt_Widgets_QTreeView_expand arginfo_class_Qt_Widgets_QTreeView_collapse

#define arginfo_class_Qt_Widgets_QTreeView_expandAll arginfo_class_Qt_Core_QAbstractItemModel_revert

#define arginfo_class_Qt_Widgets_QTreeView_isAnimated arginfo_class_Qt_Core_QThread_isCurrentThread

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Qt_Widgets_QTreeView_isExpanded, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_OBJ_INFO(0, index, Qt\\Widgets\\QModelIndex, 0)
ZEND_END_ARG_INFO()

#define arginfo_class_Qt_Widgets_QTreeView_itemsExpandable arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QTreeView_rootIsDecorated arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QTreeView_setAnimated arginfo_class_Qt_Widgets_QAbstractButton_setAutoRepeat

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Qt_Widgets_QTreeView_setItemsExpandable, 0, 1, IS_VOID, 0)
	ZEND_ARG_TYPE_INFO(0, expandable, _IS_BOOL, 0)
ZEND_END_ARG_INFO()

#define arginfo_class_Qt_Widgets_QTreeView_setModel arginfo_class_Qt_Widgets_QTableView_setModel

#define arginfo_class_Qt_Widgets_QTreeView_setRootIsDecorated arginfo_class_Qt_Widgets_QAbstractSpinBox_setGroupSeparatorShown

#define arginfo_class_Qt_Widgets_QTreeView_setSortingEnabled arginfo_class_Qt_Widgets_QAbstractButton_setAutoRepeat

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Qt_Widgets_QTreeView_setUniformRowHeights, 0, 1, IS_VOID, 0)
	ZEND_ARG_TYPE_INFO(0, uniform, _IS_BOOL, 0)
ZEND_END_ARG_INFO()

#define arginfo_class_Qt_Widgets_QTreeView_sortByColumn arginfo_class_Qt_Core_QAbstractItemModel_sort

#define arginfo_class_Qt_Widgets_QTreeView_isSortingEnabled arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QTreeView_uniformRowHeights arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QTextEdit___construct arginfo_class_Qt_Widgets_QCheckBox___construct

#define arginfo_class_Qt_Widgets_QTextEdit_acceptRichText arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QTextEdit_alignment arginfo_class_Qt_Core_QThread_idealThreadCount
...
#define arginfo_class_Qt_Widgets_QTextEdit_autoFormatting arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QTextEdit_canPaste arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Widgets_QTextEdit_fontItalic arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QTextEdit_fontPointSize arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QTextEdit_fontUnderline arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QTextEdit_fontWeight arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QTextEdit_isReadOnly arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QTextEdit_isUndoRedoEnabled arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QTextEdit_lineWrapColumnOrWidth arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QTextEdit_lineWrapMode arginfo_class_Qt_Core_QThread_idealThreadCount

#define arginfo_class_Qt_Widgets_QTextEdit_overwriteMode arginfo_class_Qt_Core_QThread_isCurrentThread
...
#define arginfo_class_Qt_Widgets_QTextEdit_tabChangesFocus arginfo_class_Qt_Core_QThread_isCurrentThread

#define arginfo_class_Qt_Widgets_QTextEdit_tabStopDistance arginfo_class_Qt_Widgets_QDial_notchTarget

#define arginfo_class_Qt_Widgets_QTextEdit_textInteractionFlags arginfo_class_Qt_Core_QThread_idealThreadCount
...
#define arginfo_class_Qt_Widgets_QTextEdit_wordWrapMode arginfo_class_Qt_Core_QThread_idealThreadCount
...
ZEND_METHOD(Qt_Core_QThread, create);
ZEND_METHOD(Qt_Core_QThread, currentThread);
...
ZEND_METHOD(Qt_Core_QThread, isCurrentThread);
...
ZEND_METHOD(Qt_Core_QThread, setStackSize);
...
ZEND_METHOD(Qt_Widgets_QTreeView, collapse);
ZEND_METHOD(Qt_Widgets_QTreeView, collapseAll);
ZEND_METHOD(Qt_Widgets_QTreeView, expand);
ZEND_METHOD(Qt_Widgets_QTreeView, expandAll);
ZEND_METHOD(Qt_Widgets_QTreeView, isAnimated);
ZEND_METHOD(Qt_Widgets_QTreeView, isExpanded);
ZEND_METHOD(Qt_Widgets_QTreeView, itemsExpandable);
ZEND_METHOD(Qt_Widgets_QTreeView, rootIsDecorated);
ZEND_METHOD(Qt_Widgets_QTreeView, setAnimated);
ZEND_METHOD(Qt_Widgets_QTreeView, setItemsExpandable);
ZEND_METHOD(Qt_Widgets_QTreeView, setModel);
ZEND_METHOD(Qt_Widgets_QTreeView, setRootIsDecorated);
ZEND_METHOD(Qt_Widgets_QTreeView, setSortingEnabled);
ZEND_METHOD(Qt_Widgets_QTreeView, setUniformRowHeights);
ZEND_METHOD(Qt_Widgets_QTreeView, sortByColumn);
ZEND_METHOD(Qt_Widgets_QTreeView, isSortingEnabled);
ZEND_METHOD(Qt_Widgets_QTreeView, uniformRowHeights);
...
static const zend_function_entry class_Qt_Core_QAbstractItemModel_methods[] = {
	...
	ZEND_ME(Qt_Core_QAbstractItemModel, rowCount, arginfo_class_Qt_Core_QAbstractItemModel_rowCount, ZEND_ACC_PUBLIC)
	...
	ZEND_ME(Qt_Core_QAbstractItemModel, dataChanged, arginfo_class_Qt_Core_QAbstractItemModel_dataChanged, ZEND_ACC_PUBLIC)
...
static const zend_function_entry class_Qt_Core_QAbstractListModel_methods[] = {
	ZEND_ME(Qt_Core_QAbstractListModel, __construct, arginfo_class_Qt_Core_QAbstractListModel___construct, ZEND_ACC_PUBLIC)
	ZEND_FE_END
};
...
static const zend_function_entry class_Qt_Core_QThread_methods[] = {
	...
	ZEND_ME(Qt_Core_QThread, create, arginfo_class_Qt_Core_QThread_create, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	ZEND_ME(Qt_Core_QThread, currentThread, arginfo_class_Qt_Core_QThread_currentThread, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	...
	ZEND_ME(Qt_Core_QThread, isCurrentThread, arginfo_class_Qt_Core_QThread_isCurrentThread, ZEND_ACC_PUBLIC)
	...
	ZEND_ME(Qt_Core_QThread, setStackSize, arginfo_class_Qt_Core_QThread_setStackSize, ZEND_ACC_PUBLIC)
	...
	ZEND_RAW_FENTRY("run", NULL, arginfo_class_Qt_Core_QThread_run, ZEND_ACC_PROTECTED|ZEND_ACC_ABSTRACT, NULL, NULL)
	ZEND_FE_END
};
...
static const zend_function_entry class_Qt_Widgets_QWidget_methods[] = {
	...
	ZEND_ME(Qt_Widgets_QWidget, setAttribute, arginfo_class_Qt_Widgets_QWidget_setAttribute, ZEND_ACC_PUBLIC)
...
static const zend_function_entry class_Qt_Widgets_QTreeView_methods[] = {
	ZEND_ME(Qt_Widgets_QTreeView, __construct, arginfo_class_Qt_Widgets_QTreeView___construct, ZEND_ACC_PUBLIC)
	ZEND_ME(Qt_Widgets_QTreeView, collapse, arginfo_class_Qt_Widgets_QTreeView_collapse, ZEND_ACC_PUBLIC)
	ZEND_ME(Qt_Widgets_QTreeView, collapseAll, arginfo_class_Qt_Widgets_QTreeView_collapseAll, ZEND_ACC_PUBLIC)
	ZEND_ME(Qt_Widgets_QTreeView, expand, arginfo_class_Qt_Widgets_QTreeView_expand, ZEND_ACC_PUBLIC)
	ZEND_ME(Qt_Widgets_QTreeView, expandAll, arginfo_class_Qt_Widgets_QTreeView_expandAll, ZEND_ACC_PUBLIC)
	ZEND_ME(Qt_Widgets_QTreeView, isAnimated, arginfo_class_Qt_Widgets_QTreeView_isAnimated, ZEND_ACC_PUBLIC)
	ZEND_ME(Qt_Widgets_QTreeView, isExpanded, arginfo_class_Qt_Widgets_QTreeView_isExpanded, ZEND_ACC_PUBLIC)
	ZEND_ME(Qt_Widgets_QTreeView, itemsExpandable, arginfo_class_Qt_Widgets_QTreeView_itemsExpandable, ZEND_ACC_PUBLIC)
	ZEND_ME(Qt_Widgets_QTreeView, rootIsDecorated, arginfo_class_Qt_Widgets_QTreeView_rootIsDecorated, ZEND_ACC_PUBLIC)
	ZEND_ME(Qt_Widgets_QTreeView, setAnimated, arginfo_class_Qt_Widgets_QTreeView_setAnimated, ZEND_ACC_PUBLIC)
	ZEND_ME(Qt_Widgets_QTreeView, setItemsExpandable, arginfo_class_Qt_Widgets_QTreeView_setItemsExpandable, ZEND_ACC_PUBLIC)
	ZEND_ME(Qt_Widgets_QTreeView, setModel, arginfo_class_Qt_Widgets_QTreeView_setModel, ZEND_ACC_PUBLIC)
	ZEND_ME(Qt_Widgets_QTreeView, setRootIsDecorated, arginfo_class_Qt_Widgets_QTreeView_setRootIsDecorated, ZEND_ACC_PUBLIC)
	ZEND_ME(Qt_Widgets_QTreeView, setSortingEnabled, arginfo_class_Qt_Widgets_QTreeView_setSortingEnabled, ZEND_ACC_PUBLIC)
	ZEND_ME(Qt_Widgets_QTreeView, setUniformRowHeights, arginfo_class_Qt_Widgets_QTreeView_setUniformRowHeights, ZEND_ACC_PUBLIC)
	ZEND_ME(Qt_Widgets_QTreeView, sortByColumn, arginfo_class_Qt_Widgets_QTreeView_sortByColumn, ZEND_ACC_PUBLIC)
	ZEND_ME(Qt_Widgets_QTreeView, isSortingEnabled, arginfo_class_Qt_Widgets_QTreeView_isSortingEnabled, ZEND_ACC_PUBLIC)
	ZEND_ME(Qt_Widgets_QTreeView, uniformRowHeights, arginfo_class_Qt_Widgets_QTreeView_uniformRowHeights, ZEND_ACC_PUBLIC)
	ZEND_FE_END
};
...
static zend_class_entry *register_class_Qt_ItemDataRole(void)
{
	zend_class_entry ce, *class_entry;

	INIT_NS_CLASS_ENTRY(ce, "Qt", "ItemDataRole", NULL);
	class_entry = zend_register_internal_class_with_flags(&ce, NULL, 0);

	zval const_DisplayRole_value;
	ZVAL_LONG(&const_DisplayRole_value, 0);
	zend_string *const_DisplayRole_name = zend_string_init_interned("DisplayRole", sizeof("DisplayRole") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_DisplayRole_name, &const_DisplayRole_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_DisplayRole_name);

	zval const_DecorationRole_value;
	ZVAL_LONG(&const_DecorationRole_value, 1);
	zend_string *const_DecorationRole_name = zend_string_init_interned("DecorationRole", sizeof("DecorationRole") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_DecorationRole_name, &const_DecorationRole_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_DecorationRole_name);

	zval const_EditRole_value;
	ZVAL_LONG(&const_EditRole_value, 2);
	zend_string *const_EditRole_name = zend_string_init_interned("EditRole", sizeof("EditRole") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_EditRole_name, &const_EditRole_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_EditRole_name);

	zval const_ToolTipRole_value;
	ZVAL_LONG(&const_ToolTipRole_value, 3);
	zend_string *const_ToolTipRole_name = zend_string_init_interned("ToolTipRole", sizeof("ToolTipRole") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_ToolTipRole_name, &const_ToolTipRole_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_ToolTipRole_name);

	zval const_StatusTipRole_value;
	ZVAL_LONG(&const_StatusTipRole_value, 4);
	zend_string *const_StatusTipRole_name = zend_string_init_interned("StatusTipRole", sizeof("StatusTipRole") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_StatusTipRole_name, &const_StatusTipRole_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_StatusTipRole_name);

	zval const_WhatsThisRole_value;
	ZVAL_LONG(&const_WhatsThisRole_value, 5);
	zend_string *const_WhatsThisRole_name = zend_string_init_interned("WhatsThisRole", sizeof("WhatsThisRole") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_WhatsThisRole_name, &const_WhatsThisRole_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_WhatsThisRole_name);

	zval const_SizeHintRole_value;
	ZVAL_LONG(&const_SizeHintRole_value, 13);
	zend_string *const_SizeHintRole_name = zend_string_init_interned("SizeHintRole", sizeof("SizeHintRole") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_SizeHintRole_name, &const_SizeHintRole_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_SizeHintRole_name);

	zval const_FontRole_value;
	ZVAL_LONG(&const_FontRole_value, 6);
	zend_string *const_FontRole_name = zend_string_init_interned("FontRole", sizeof("FontRole") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_FontRole_name, &const_FontRole_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_FontRole_name);

	zval const_TextAlignmentRole_value;
	ZVAL_LONG(&const_TextAlignmentRole_value, 7);
	zend_string *const_TextAlignmentRole_name = zend_string_init_interned("TextAlignmentRole", sizeof("TextAlignmentRole") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_TextAlignmentRole_name, &const_TextAlignmentRole_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_TextAlignmentRole_name);

	zval const_BackgroundRole_value;
	ZVAL_LONG(&const_BackgroundRole_value, 8);
	zend_string *const_BackgroundRole_name = zend_string_init_interned("BackgroundRole", sizeof("BackgroundRole") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_BackgroundRole_name, &const_BackgroundRole_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_BackgroundRole_name);

	zval const_ForegroundRole_value;
	ZVAL_LONG(&const_ForegroundRole_value, 9);
	zend_string *const_ForegroundRole_name = zend_string_init_interned("ForegroundRole", sizeof("ForegroundRole") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_ForegroundRole_name, &const_ForegroundRole_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_ForegroundRole_name);

	zval const_CheckStateRole_value;
	ZVAL_LONG(&const_CheckStateRole_value, 10);
	zend_string *const_CheckStateRole_name = zend_string_init_interned("CheckStateRole", sizeof("CheckStateRole") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_CheckStateRole_name, &const_CheckStateRole_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_CheckStateRole_name);

	zval const_InitialSortOrderRole_value;
	ZVAL_LONG(&const_InitialSortOrderRole_value, 14);
	zend_string *const_InitialSortOrderRole_name = zend_string_init_interned("InitialSortOrderRole", sizeof("InitialSortOrderRole") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_InitialSortOrderRole_name, &const_InitialSortOrderRole_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_InitialSortOrderRole_name);

	zval const_AccessibleTextRole_value;
	ZVAL_LONG(&const_AccessibleTextRole_value, 11);
	zend_string *const_AccessibleTextRole_name = zend_string_init_interned("AccessibleTextRole", sizeof("AccessibleTextRole") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_AccessibleTextRole_name, &const_AccessibleTextRole_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_AccessibleTextRole_name);

	zval const_AccessibleDescriptionRole_value;
	ZVAL_LONG(&const_AccessibleDescriptionRole_value, 12);
	zend_string *const_AccessibleDescriptionRole_name = zend_string_init_interned("AccessibleDescriptionRole", sizeof("AccessibleDescriptionRole") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_AccessibleDescriptionRole_name, &const_AccessibleDescriptionRole_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_AccessibleDescriptionRole_name);

	return class_entry;
}

static zend_class_entry *register_class_Qt_ItemFlag(void)
{
	zend_class_entry ce, *class_entry;

	INIT_NS_CLASS_ENTRY(ce, "Qt", "ItemFlag", NULL);
	class_entry = zend_register_internal_class_with_flags(&ce, NULL, 0);

	zval const_NoItemFlags_value;
	ZVAL_LONG(&const_NoItemFlags_value, 0);
	zend_string *const_NoItemFlags_name = zend_string_init_interned("NoItemFlags", sizeof("NoItemFlags") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_NoItemFlags_name, &const_NoItemFlags_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_NoItemFlags_name);

	zval const_ItemIsSelectable_value;
	ZVAL_LONG(&const_ItemIsSelectable_value, 1);
	zend_string *const_ItemIsSelectable_name = zend_string_init_interned("ItemIsSelectable", sizeof("ItemIsSelectable") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_ItemIsSelectable_name, &const_ItemIsSelectable_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_ItemIsSelectable_name);

	zval const_ItemIsEditable_value;
	ZVAL_LONG(&const_ItemIsEditable_value, 2);
	zend_string *const_ItemIsEditable_name = zend_string_init_interned("ItemIsEditable", sizeof("ItemIsEditable") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_ItemIsEditable_name, &const_ItemIsEditable_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_ItemIsEditable_name);

	zval const_ItemIsDragEnabled_value;
	ZVAL_LONG(&const_ItemIsDragEnabled_value, 4);
	zend_string *const_ItemIsDragEnabled_name = zend_string_init_interned("ItemIsDragEnabled", sizeof("ItemIsDragEnabled") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_ItemIsDragEnabled_name, &const_ItemIsDragEnabled_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_ItemIsDragEnabled_name);

	zval const_ItemIsDropEnabled_value;
	ZVAL_LONG(&const_ItemIsDropEnabled_value, 8);
	zend_string *const_ItemIsDropEnabled_name = zend_string_init_interned("ItemIsDropEnabled", sizeof("ItemIsDropEnabled") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_ItemIsDropEnabled_name, &const_ItemIsDropEnabled_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_ItemIsDropEnabled_name);

	zval const_ItemIsUserCheckable_value;
	ZVAL_LONG(&const_ItemIsUserCheckable_value, 16);
	zend_string *const_ItemIsUserCheckable_name = zend_string_init_interned("ItemIsUserCheckable", sizeof("ItemIsUserCheckable") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_ItemIsUserCheckable_name, &const_ItemIsUserCheckable_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_ItemIsUserCheckable_name);

	zval const_ItemIsEnabled_value;
	ZVAL_LONG(&const_ItemIsEnabled_value, 32);
	zend_string *const_ItemIsEnabled_name = zend_string_init_interned("ItemIsEnabled", sizeof("ItemIsEnabled") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_ItemIsEnabled_name, &const_ItemIsEnabled_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_ItemIsEnabled_name);

	zval const_ItemIsAutoTristate_value;
	ZVAL_LONG(&const_ItemIsAutoTristate_value, 64);
	zend_string *const_ItemIsAutoTristate_name = zend_string_init_interned("ItemIsAutoTristate", sizeof("ItemIsAutoTristate") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_ItemIsAutoTristate_name, &const_ItemIsAutoTristate_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_ItemIsAutoTristate_name);

	zval const_ItemNeverHasChildren_value;
	ZVAL_LONG(&const_ItemNeverHasChildren_value, 128);
	zend_string *const_ItemNeverHasChildren_name = zend_string_init_interned("ItemNeverHasChildren", sizeof("ItemNeverHasChildren") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_ItemNeverHasChildren_name, &const_ItemNeverHasChildren_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_ItemNeverHasChildren_name);

	zval const_ItemIsUserTristate_value;
	ZVAL_LONG(&const_ItemIsUserTristate_value, 256);
	zend_string *const_ItemIsUserTristate_name = zend_string_init_interned("ItemIsUserTristate", sizeof("ItemIsUserTristate") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_ItemIsUserTristate_name, &const_ItemIsUserTristate_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_ItemIsUserTristate_name);
...
static zend_class_entry *register_class_Qt_Core_QAbstractItemModel(zend_class_entry *class_entry_Qt_Core_QObject)
{
	zend_class_entry ce, *class_entry;
	...
	zend_string *const_NoOption_name = zend_string_init_interned("NoOption", sizeof("NoOption") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_NoOption_name, &const_NoOption_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_NoOption_name);

	zval const_IndexIsValid_value;
	ZVAL_LONG(&const_IndexIsValid_value, 1);
	zend_string *const_IndexIsValid_name = zend_string_init_interned("IndexIsValid", sizeof("IndexIsValid") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_IndexIsValid_name, &const_IndexIsValid_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_IndexIsValid_name);

	zval const_DoNotUseParent_value;
	ZVAL_LONG(&const_DoNotUseParent_value, 2);
	zend_string *const_DoNotUseParent_name = zend_string_init_interned("DoNotUseParent", sizeof("DoNotUseParent") - 1, 1);
	zend_declare_typed_class_constant(class_entry, const_DoNotUseParent_name, &const_DoNotUseParent_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_LONG));
	zend_string_release(const_DoNotUseParent_name);

	zval const_ParentIsInvalid_value;
	ZVAL_LONG(&const_ParentIsInvalid_value, 4);
...
static zend_class_entry *register_class_Qt_Core_QAbstractListModel(zend_class_entry *class_entry_Qt_Core_QAbstractItemModel)
{
	zend_class_entry ce, *class_entry;

	INIT_NS_CLASS_ENTRY(ce, "Qt\\Core", "QAbstractListModel", class_Qt_Core_QAbstractListModel_methods);
	class_entry = zend_register_internal_class_with_flags(&ce, class_entry_Qt_Core_QAbstractItemModel, 0);
...
static zend_class_entry *register_class_Qt_Widgets_QTreeView(zend_class_entry *class_entry_Qt_Widgets_QAbstractItemView)
{
	zend_class_entry ce, *class_entry;

	INIT_NS_CLASS_ENTRY(ce, "Qt\\Widgets", "QTreeView", class_Qt_Widgets_QTreeView_methods);
	class_entry = zend_register_internal_class_with_flags(&ce, class_entry_Qt_Widgets_QAbstractItemView, 0);
